    ...
    render() {
        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <View>
                    <Animated.View style={[styles.flipCard, styles.face, frontAnimatedStyle]}>
                    ...
                    <Animated.View style={[styles.flipCard, styles.flipCardBack, styles.back, backAnimatedStyle]}>
